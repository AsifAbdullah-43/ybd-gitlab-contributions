...
Below is a list of key projects and a summary of the contributions made:

### 🛠️ Project: Fusion ERP
...
- 💻 **Total Commits:** 1200+ commits across 5 Projects
- 📦 **Tech Stack:** ASP.NET MVC, .NET 8, JavaScript, MSSQL, Crystal Report, GitLab, SOLID, DDD, etc.
- 🧠 **Practices:** Agile (Scrum), Code Reviews, Merge Requests, Pair Programming

## ⚠️ Disclaimer

Due to the private nature of the repositories, commit history cannot be shared publicly. However, detailed logs and contribution evidence are available upon request for verification or interview purposes.

---

Feel free to reach out if you'd like more information about specific projects or contributions.
